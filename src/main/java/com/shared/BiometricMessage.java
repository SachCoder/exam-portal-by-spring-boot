...
public interface BiometricMessage {
	 

	    String PRODUCT_NOT_FOUND = "Product Not Found!";

	    String EMP_ADD = "Product Deleted";
	    ...
	    String USER_NOT_LOGIN = "User NOT Login! Login failed !!";
	    String USER_ALREADY_EXIST = "User NOT Created! Already exist";
	    String USER_BLOCKED_CREATED = "User Blocked! Blocked";
	    
	    String OTP_AUTH_SUCCESS = "Otp Authentication success! success";
	    String USERNAME_ALREADY_IN_USE = "Username Already In Use!";
	    
	    String OTP_RESEND_SUCCESS = "Otp resend Success!";
	    String OTP_ERROR = "Otp error!";
